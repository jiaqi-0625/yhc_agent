...
> 当前状态：暂停执行。2026-08-20 的[产品规格第 12.3 节](../workspace-v2-product-spec.md#123-当前持久化边界)已将开发与验收运行时改回本地 Workspace V2 文件 Store；本文保留 PostgreSQL 适配器的技术约束，不代表数据库已重新启用。重新启用前须重新确认迁移、运行和发布方案。
